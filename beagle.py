...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + beagle
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("facetattoo", 1, "face")
        self.add_class("facetattoo", 2, "tattoo")
        ...
        for a in annotations:
            ...
            self.add_image(
                "face",  ## for a single class just add the name here
                "tattoo",
